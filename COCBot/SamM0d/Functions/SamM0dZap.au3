...
; ===============================================================================================================================
	...
	Func SamM0dZap($sMode = "Elixir")
		...
		Local $sResourceModeMine = ""
		Local $sResourceModeVillage = ""
		
		Switch $sMode
			Case "Dark"
				$sResourceModeMine = "GetLocationDarkElixirWithLevel()"
				$sResourceModeVillage = "getDarkElixirVillageSearch(48, 126)"
			Case "Elixir"
				$sResourceModeMine = "GetLocationElixirWithLevel()"
				$sResourceModeVillage = "getElixirVillageSearch(48, 69 + 29)"
			Case "Gold"
				$sResourceModeMine = "GetLocationMineWithLevel()"
				$sResourceModeVillage = "getGoldVillageSearch(48, 69)"
		EndSwitch
		...
		$searchDark = Execute($sResourceModeVillage)
		...
		$result = Execute($sResourceModeMine)
	...
	Func getDarkElixirStable($oldSearchDark)
		...
		If _ColorCheck(_GetPixelColor(30, 143, True), Hex(0x282020, 6), 10) Or _ColorCheck(_GetPixelColor(36, 140, True), Hex(0x302430, 6), 10) Then ; Check if the village have a Dark Elixir Storage
			...
			While $iCount <= 15
				$searchDark = Execute($sResourceModeVillage) ; Get updated Dark Elixir value
