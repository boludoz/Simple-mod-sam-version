...
Func BuilderBaseCheckMachine(ByRef $aMachineStatus, $bTestRun = 0)
	...
	If IsMainPageBuilderBase() Then
		; Machine Detection
		Local $MachinePosition = _ImageSearchXMLBoludoz($g_sXMLTroopsUpgradeMachine, $g_aXMLToForceBuilderBaseParms[0], $g_aXMLToForceBuilderBaseParms[1], $g_aXMLToForceBuilderBaseParms[2], $bTestRun)
