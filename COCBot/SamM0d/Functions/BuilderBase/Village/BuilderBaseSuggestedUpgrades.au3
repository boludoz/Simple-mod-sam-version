...
Func NewBuildings($aResult, $DebugLog = False)
	...
	If UBound($aResult) = 3 And $aResult[2] = "New" Then
		...
		For $i = 0 To 30
			...
			Local $DetectionShop = _ImageSearchXMLMyBot($g_sXMLAutoUpgradeShop, $g_aXMLToForceAreaParms[0], $g_aXMLToForceAreaParms[1], $g_aXMLToForceAreaParms[2], $DebugLog)
		...
		Local $DetectionClock = _ImageSearchXMLMyBot($g_sXMLAutoUpgradeClock, $g_aXMLToForceAreaParms[0], $g_aXMLToForceAreaParms[1], $g_aXMLToForceAreaParms[2], $DebugLog)
		...
		For $j = 0 To 10
			...
			Local $DetectionYes = _ImageSearchXMLMyBot($g_sXMLAutoUpgradeNewBldgYes, $g_aXMLToForceAreaParms[0], $g_aXMLToForceAreaParms[1], $g_aXMLToForceAreaParms[2], $DebugLog)
