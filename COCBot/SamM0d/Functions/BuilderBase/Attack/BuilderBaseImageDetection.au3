...
Func TestBuilderBaseGetHall()
	...
	Local $BuilderHallPos = _ImageSearchBundlesMyBot($g_sBundleBuilderHall, $g_aBundleBuilderHallParms[0], $g_aBundleBuilderHallParms[1], $g_aBundleBuilderHallParms[2], True)
...
Func BuilderBaseGetDeployPoints($FurtherFrom = 0, $DebugImage = False)
	...
	For $i = 0 To 2
		Local $BuilderHallPos = _ImageSearchBundlesMyBot($g_sBundleBuilderHall, $g_aBundleBuilderHallParms[0], $g_aBundleBuilderHallParms[1], $g_aBundleBuilderHallParms[2], $DebugLog)
	...
	Local $DeployPointsResult = _ImageSearchXMLBoludoz($g_sBundleDeployPointsBB, $g_aBundleDeployPointsBBParms[0], $g_aBundleDeployPointsBBParms[1], $g_aBundleDeployPointsBBParms[2], $DebugLog)
