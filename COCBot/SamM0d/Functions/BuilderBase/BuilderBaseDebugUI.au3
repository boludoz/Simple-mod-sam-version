...
#Tidy_Off
	...
	$x += 75
		$btnDrop = GUICtrlCreateButton("Drop Trophies", $x, $y, 75, 25, $WS_GROUP)
	...
	$x += 75
		$btnAttackBar = GUICtrlCreateButton("AttackBar", $x, $y, 75, 25, $WS_GROUP)
			GUICtrlSetOnEvent($btnAttackBar, "TestBuilderBaseAttackBar")
	$x += 75
		$btnIMG = GUICtrlCreateButton("Collect", $x, $y, 60, 25, $WS_GROUP)
			GUICtrlSetOnEvent($btnIMG, "NewImageDetection")
	$x += 60
...
Func GuiDebug()
	...
	$g_frmGuiDebug = GUICreate("DEBUG-IMAGE ONSCREEN @ PROMAC 2018 ", 860, 644, -1, -1, -1, $WS_EX_LAYERED)
